...
ggplot(df) + 
  ...
  ylab("Frequency")+ 
  xlab("Year") + 
  ggtitle("Kickstarter Campaign Status Over Time")
  scale_colour_manual(values = c("red", "blue", "green"))

```

```{r}
ggplot( x = all_aggr_data$Category, y = all_aggr_data$ xlab = 'Year', ylab = 'Total Kickstarters', main = "Count of Kickstarters Over Time" )
...
```{r}
ggplot(data = meanPledgedByCat, aes(x=Category, y=MeanPledged)) +
